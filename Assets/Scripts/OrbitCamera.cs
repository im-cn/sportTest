...
public class OrbitCamera : MonoBehaviour
{
    ...
    [SerializeField, Min(0f)] //相机焦点和球体的最大距离
    float focusRadius = 1f;

    Vector3 focusPoint; //相机焦点位置
    Vector3 previousFocusPoint;

    [SerializeField, Range(0f, 1f)]  //焦点居中系数
    float focusCentering = 0.5f;

    Vector2 orbitAngles = new Vector2(45f, 0f); //相机角度

    [SerializeField, Range(1f, 360f)] //旋转速率
    ...
    void LateUpdate()
    {
        ...
        if (MaunalRotation() || AutomaticRotation()) //如果摄像机位置变了
        {
            ConstrainAngles();
